...
void main() {
  ...
  try { 
    ...
    double finalGrade =
        ...
        (finalExam * finalExamWeight); // this is the calculation of final grade by applying assignment midterm and finalexam 
    ...
    if (finalGrade >= passingGrade) { // using this if else to show their grade if pass or failed
      print("Passed!");
    } else {
      print("sorry you Failed.");
    }
  } catch (e) {
    print("Error: Please enter valid numeric scores only."); // to return and enter another valid number
  }
}
